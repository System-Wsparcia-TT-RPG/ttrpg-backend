...
def validate_race(race_json) -> bool:
    ...
    return race_fields_exist(race_json) and validate_race_actions(race_json['actions']) and validate_race_traits(
        race_json['traits'] and validate_source(race_json['source']))
