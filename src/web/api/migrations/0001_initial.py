    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('damage_dice', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.damagedice')),
            ],
        ),
        migrations.CreateModel(
            name='CombatStats',
            fields=[
                ...
                ('death_saves', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.deathsaves')),
            ],
        ),
        migrations.CreateModel(
            name='Class',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('senses', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.senses')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('properties', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=100), size=None)),
                ('source', models.CharField(max_length=100)),
                ('damage_dice', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.damagedice')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weapon_proficiencies', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=100), size=None)),
                ('armor_proficiencies', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=100), size=None)),
                ('tool_proficiencies', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=100), size=None)),
                ('ability_scores', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.abilityscores')),
                ('background', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.background')),
                ('classes', models.ManyToManyField(to='api.class')),
                ('combat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.combatstats')),
                ('details', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.details')),
                ...
                ('saving_throws', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.savingthrows')),
                ...
                ('treasure', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.treasure')),
